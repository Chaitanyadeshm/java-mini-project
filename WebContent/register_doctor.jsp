...
<head>
	...
	<link rel="stylesheet" href="css/multi-select-specialization.css">
	<style>
		body {
			color: #fff;
			background: #63738a;
...
<header>
		...
		<div class="container">
		  ...
		  <div class="collapse navbar-collapse" id="navbarmain">
			<ul class="navbar-nav ml-auto">
			  ...
			  <c:if test="${role_id == 1}">
			  	<li class="nav-item"><a class="nav-link" href="show_doctors.jsp">Doctors</a></li>
			  </c:if>
	...
	<div class="signup-form">
		<form action="registerDoctor" method="post">
			<h2>Register</h2>
			<p class="hint-text">Register a Doctor into our existing team of professionals.</p>
			...
			<div class="form-group">
				<div class="row">
					<div class="col"><input type="number" class="form-control" name="mobile" placeholder="Mobile no."
							required="required"></div>
		...
		<%-- 	<div class="form-group">
					...
					<select multiple="multiple" id="myMulti" name="spp">
						<c:forEach items="${ applicationScope.specializations }" var="specialization"> 
					
							<option value="${specialization.specializationId }">   <c:out value="${specialization.category}"></c:out>  </option> 
						</c:forEach> 
					</select>
			</div> --%>
			<div class="form-group">
...
<footer class="footer  gray-bg">
	...
	<script src="js/multi-select-specialization.js"></script>
