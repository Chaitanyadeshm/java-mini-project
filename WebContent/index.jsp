				...
				<div class="col-lg-12">
					<div class="feature-block d-lg-flex">
						...
						<div class="feature-item mb-5 mb-lg-0">
							...
							<a href="ShowAllUsers" class="btn btn-main btn-round-full">View ALl Users</a>
						</div>
						...
						<div class="feature-item mb-5 mb-lg-0">
							...
							<p>Update the appointment status of patients so doctor can see patient.</p>
							 <a href="viewAppointments" class="btn btn-main btn-round-full">Manage Appointments</a>
						</div>
					</div>
				</div>
			</div>
...
<form action="IndexHome" method="post">
                    ...
                    <div class="row">
                         <div class="col-lg-6">
                            <div class="form-group">
                                <select class="form-control" id="exampleFormControlSelect1" name="selected_specialization">
                        ...
                        <button type="submit" class="btn btn-main btn-round-full mb-3">Find Doctor<i class="icofont-simple-right ml-2 mb-2 "></i></button> 
                    </div>
