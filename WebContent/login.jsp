...
<body>
	...
	<div class="signup-form">
		<form action="LoginUser" method="post">
			<h2>Login</h2>
			<p class="hint-text">Login to Health Care System. Your's one site solution for all health related problems</p>
			...
			<div class="form-group">
				...
				<p class="hint-text">Don't have an account? <a href="patient_register.jsp">Register. </a></p>
			</div>
		</form>
	</div>
</body>
